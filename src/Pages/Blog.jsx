        ...
        <div className="pt-5">
            <Container>
                ...
                <Row className="align-items-center mb-5">
                    <Col lg={5}>
                        <Image
                            src="https://mjproductsco.com/wp-content/uploads/2023/08/iStock-1364577495_reduced.jpg"
                            alt="Locker Room"
                            fluid
                            rounded
                        />
                ...
                <Row className="align-items-center mb-5 flex-lg-row-reverse">
                    <Col lg={5}>
                        <Image
                            src="https://s0.rbk.ru/v6_top_pics/media/img/9/39/756808723403399.jpg"
                            alt="Restaurant"
                            fluid
                            rounded
                        />
                ...
                <Row className="align-items-center mb-5">
                    <Col lg={5}>
                        <Image
                            src="https://images.unsplash.com/photo-1616363088386-31c4a8414858"
                            alt="Car Parking Area"
                            fluid
                            rounded
                        />
                    </Col>
                ...
                <Row className="align-items-center mb-5 flex-lg-row-reverse">
                    <Col lg={5}>
                        <Image
                            src="https://architizer-prod.imgix.net/media/mediadata/uploads/1554276184209BJK10.jpg"
                            alt="Gym Center"
                            fluid
                            rounded
                        />
                ...
                <Row className="align-items-center mb-5">
                    <Col lg={5}>
                        <Image
                            src="https://3.bp.blogspot.com/-hqp-nmJVzH0/WmhTL53kQtI/AAAAAAAAAAM/nrb0Ni-W_gkUmSDxS4x_7gXiBF568QxEACLcBGAs/s1600/Swimming%2BPool%2BConstruction%2BAdelaide.jpg"
                            alt="Swimming Pool"
                            fluid
                            rounded
                        />
