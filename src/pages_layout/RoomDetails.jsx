...
//     return room && (
//         <>
//             <div className="page-content9 details1 px-3 px-md-5 px-lg-6">
//                 {/* {room details} */}
...
//                 </div>
//                 <div
//                     className="border-top border-bottom border-secondary text-secondary Guests">
//                     <p>
...
const RoomDetails = () => {
    ...
    return room && (
        <Container fluid className="details1 py-5 px-3 px-md-5 px-lg-6">
            {/* Header */}
            <Row className="align-items-center text-center text-md-start mb-2">
                <Col md="auto">
                    <h1 className="font1 mb-0 fs-3 fs-md-2">
                        {room.hotel.name} <span className="fw-normal small">({room.roomType})</span>
                    </h1>
                </Col>
                <Col md="auto">
                    <p className="small text-white bg-warning rounded-pill d-inline-block py-1 px-3 mt-2 mt-md-0">
                        20% OFF
                    </p>
                </Col>
            </Row>
            ...
            <Row className="align-items-center mb-2">
                <Col xs="auto" className="d-flex">
                    <img src={assets.starIconFilled} alt="star1" />
                    <img src={assets.starIconFilled} alt="star2" />
                    <img src={assets.starIconFilled} alt="star3" />
                    <img src={assets.starIconFilled} alt="star4" />
                    <img src={assets.starIconFilled} alt="star5" />
                </Col>
                <Col><p className="mb-0">200+ Reviews</p></Col>
            </Row>

            {/* Location */}
            <Row className="align-items-center text-secondary mb-3">
                <Col xs="auto"><img src={assets.locationIcon} alt="location" /></Col>
                <Col><span>{room.hotel.address}</span></Col>
            </Row>
            ...
            <Row className="g-3">
                <Col lg={6}>
                    <img
                        src={mainImage}
                        className="w-100 rounded shadow img-fluid"
                        ...
                        {room.images.map((image, index) => (
                            <Col key={index}>
                                <img
                                    ...
                                    className={`w-100 rounded shadow img-fluid ${mainImage === image ? 'border border-3 border-warning' : ''}`}
                                    alt={`Thumb ${index}`}
            ...
            <Row className="mt-4 gy-4">
                <Col md={8}>
                    <h2 className="font1 fw-normal fs-4">Experience Luxury Like Never Before</h2>
                    <div className="d-flex flex-wrap gap-3 mt-3">
                        {room.amenities.map((item, index) => (
                            <div key={index} className="d-flex align-items-center px-3 py-2 rounded bg-light gap-2">
                                <img src={facilityIcons[item]} style={{ width: "20px", height: "20px" }} alt={item} />
            ...
            {/* Booking Form */}
            <Row className="bg-white rounded mx-auto mt-4 p-3 shadow-sm justify-content-between align-items-center" style={{ maxWidth: "1150px" }}>
                <Col xs={12} md={3} className="mb-3 mb-md-0">
                    <Form.Label className="fw-medium">Check-In</Form.Label>
                    <Form.Control type="date" required className="mt-2" />
                </Col>
                <Col xs={12} md={3} className="mb-3 mb-md-0">
                ...
                <Col xs={12} md={2} className="mb-3 mb-md-0">
                    ...
                    <Form.Control type="number" required placeholder="0" className="mt-2" />
                </Col>
                <Col xs={12} md="auto" className="text-md-end">
                    <Button type="submit" variant="primary" className="w-100 w-md-auto mt-3 mt-md-0 px-md-5 py-3">
                        Check Availability
                    </Button>
                </Col>
            </Row>
            ...
            {/* Guest Info */}
            <Row className="border-top border-bottom border-secondary py-3 mt-4">
                <Col className="text-secondary">
                    <p>
                        Guests will be allocated on the ground floor according to availability. You get a comfortable
                        two-bedroom apartment with a true city feeling. The price is for two guests. Mark the number
            ...
            <Row className="mt-4 align-items-start">
                <Col md="auto">
                    <img
                        ...
                        style={{ height: "72px", width: "72px", objectFit: "cover" }}
                        alt="Owner"
                    />
                </Col>
                <Col>
                    <p className="fs-5 mb-1">Hosted by {room.hotel.name}</p>
                    <div className="d-flex align-items-center mt-1">
                        <img src={assets.starIconFilled} alt="star1" />
                        <img src={assets.starIconFilled} alt="star2" />
                        <img src={assets.starIconFilled} alt="star3" />
